                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"
                                method="POST" action={{ route('pelanggan.update', $pelanggan->id) }}>
                                @csrf
                                @method('PUT')
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <input type="date" id="first-name" required="required" class="form-control "
                                            name="tanggal_pesanan" value={{ $pelanggan->tanggal_pesanan }}>
                                    </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <input type="time" id="first-name" required="required" class="form-control "
                                            name="waktu_pemesanan" value={{ $pelanggan->waktu_pemesanan }}>
                                    </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <select class="form-control" name="menu_id">
                                            <option value={{ $pelanggan->menu_id }}>{{ $pelanggan->menu->nama_menu }}</option>
